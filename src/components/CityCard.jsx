...
class CityCard extends React.Component {
  ...
  render() {
    ...
    const { isAllForecast } = this.state;
      ...
      <div className="city-card">
        ...
        <Paper className="city-card__box" zDepth={1}>
          ...
          <div className="city-card__forecasts">
            <h2 className="city-card__forecasts-header">
              {`Forecast for ${!isAllForecast ? 7 : 13} days`}
            </h2>
            ...
            <ul className={`forecast ${!isAllForecast ? 'forecast--collapsed' : ''}`}>
              <li className="forecast__day">
                <div className="forecast__date">Wed 19 Jul</div>
                <div className="forecast__sky-state"><span className="meteocons" data-icon="S" /></div>
                <div className="forecast__temperature">
          ...
          </div>
          {
            ...
            ?
              <div className="city-card__action">
                <button
                  className="btn city-card__forecasts-btn"
                  onClick={this.handleGetMoreForecast}
                >
                  More
                </button>
              </div>
